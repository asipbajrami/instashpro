...
# Log Viewer Auth
LOG_VIEWER_USERNAME=${LOG_VIEWER_USERNAME:?LOG_VIEWER_USERNAME environment variable is required}
LOG_VIEWER_PASSWORD=${LOG_VIEWER_PASSWORD:?LOG_VIEWER_PASSWORD environment variable is required}
