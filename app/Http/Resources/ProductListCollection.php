...
/**
 * Lightweight collection for product catalog views.
 * Uses ProductListResource for minimal data transfer.
 */
class ProductListCollection extends ResourceCollection
{
    ...
    {
        return [
            'items' => ProductListResource::collection($this->collection),
            'pagination' => [
