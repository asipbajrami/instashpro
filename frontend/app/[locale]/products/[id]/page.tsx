...
import { ChevronLeft, X, ZoomIn, Download, ExternalLink, Calendar } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Instagram Link & Post Date */}
          {(product.instagram_link || product.published_at) && (
            <div className="flex flex-wrap items-center gap-4">
              ...
              {product.published_at && (
                <span className="inline-flex items-center gap-1.5 text-sm text-muted-foreground">
                  ...
                  Posted {new Date(product.published_at).toLocaleDateString('en-US', { 
                    month: 'short', 
                    day: 'numeric', 
                    year: 'numeric' 
                  })}
